...
export default function Layout({ user, onLogout }) {
  ...
  const updateCacheSizeLabel = useCallback(() => {
    ...
    measureOfflineCacheSize()
      .then((s) => setCacheSizeLabel(formatBytes(s.totalBytes ?? 0)))
      .catch(() => setCacheSizeLabel('—'));
  }, []);
    ...
    const check = () => {
      ...
      auth.me()
        ...
        .catch(() => {
          if (isQuickDeviceEnabled()) {
            getCachedUser()
              .then((u) => setServerOnline(Boolean(u)))
        ...
        <div className="max-w-[100rem] mx-auto px-2 sm:px-3">
          <div className="flex items-center justify-between gap-2 h-9">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <span
                className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-2xs font-medium tabular-nums ${
                  isAppOnline
