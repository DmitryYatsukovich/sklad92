    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-zinc-400 text-sm mt-1">
          Справочники склада и мест проведения работ: склады, стеллажи, категории; объекты, подъезды, этажи, квартиры и помещения — во вкладке «Место проведения работ».
        </p>
      </div>
