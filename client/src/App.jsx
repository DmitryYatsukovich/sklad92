  ...
  return (
    <Routes>
      <Route path="/" element={<Layout user={user} onLogout={onLogout} />}>
        ...
        <Route path="settings" element={<ProtectedRoute user={user} perm="can_settings"><Settings /></ProtectedRoute>} />
        ...
        <Route path="face" element={<ProtectedRoute user={user} perm="can_face"><FaceCheckIn /></ProtectedRoute>} />
